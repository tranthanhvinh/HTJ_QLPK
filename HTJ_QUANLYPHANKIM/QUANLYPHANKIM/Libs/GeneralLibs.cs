...
{
    public class GeneralLibs
    {
        public static IOverlaySplashScreenHandle handle = null;
        public static DataLayer.User user = null;

        public static List<InventoryTransactionDetail> lstChungTuCT = new List<InventoryTransactionDetail>();
        ...
        //        userPermission = KhoaiCodeLibs.PhanQuyen(KhoaiCodeLibs.user.UserId, permissionId);
